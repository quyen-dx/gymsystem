...
router.patch('/:id/cancel-admin', authorize('admin', 'super_admin', 'staff'), ctrl.cancelRequestByAdmin)
router.get('/pt1on1/counts', authorize('admin', 'super_admin', 'staff'), ctrl.getPt1on1Counts)
router.get('/:id/pt-suggestions', authorize('admin', 'super_admin', 'staff'), ctrl.getPtSuggestions)

...
const shortsFrameClass = 'relative h-[calc(100dvh-112px)] min-h-[calc(100dvh-112px)] overflow-hidden rounded-[18px] bg-[#050505] text-white max-[640px]:h-[calc(100dvh-86px)] max-[640px]:min-h-[calc(100dvh-86px)] max-[640px]:rounded-none'
const loadingStateClass = 'relative grid h-[calc(100dvh-112px)] min-h-[calc(100dvh-112px)] place-items-center bg-[radial-gradient(circle_at_top,rgba(255,45,85,0.2),transparent_34%),#050505] p-6 text-white max-[640px]:h-[calc(100dvh-86px)] max-[640px]:min-h-[calc(100dvh-86px)]'
...
const uploadPreviewClass = 'mt-3.5 aspect-[9/16] max-h-[420px] overflow-hidden rounded-[18px] border border-white/10 bg-[#080808]'
      ...
      <div className={loadingStateClass}>
        ...
        <div className={panelClass}>
          <Empty
            ...
            description={<span style={{ color: '#fff' }}>Chưa có video Shorts nào</span>}
          />
        </div>
        <UploadModal
          form={form}
      ...
      <div className="h-full w-full">
        ...
        >
          {videos.map((video, index) => {
            ...
            return (
              <SwiperSlide className="grid place-items-center bg-[#050505]" key={video._id}>
                <ShortsVideoCard
                  video={video}
          ...
          {loadingMore && (
            <SwiperSlide className="grid place-items-center bg-[#050505]">
              <div className={panelClass}>
